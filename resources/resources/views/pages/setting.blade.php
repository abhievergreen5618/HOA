                                ...
                                <div class="invalid-feedback fw-bold">Please upload an image.</div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="card card-primary">
                                                    ...
                                                    <form id="passwordform" action="{{ route('password') }}" method="POST">
                                                        @csrf
                                     ...
                                     @csrf
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="card card-primary">
                                                    <div class="card-header">
                                                        <h3 class="card-title">Not in DB Heading</h3>
                                                    </div>
                                    ...
                                    <form method="post" id="urlForm" action="{{ route('url') }}">
                                            @csrf
                                            <div class="card card-primary">
                                                <div class="card card-primary">
                                                    <div class="card-header">
                                                        <h3 class="card-title">Mailbox URL</h3>
                                                    </div>
                                                </div>
                                                <div class="card-body">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <input type="text" class="form-control" name="heading3" value="{{ $heading3->heading }}">
                                                    </div>
                                                    <div class="col">
                                                        <label>Product URL 2</label>
                                                        <input type="text" class="form-control" name="heading4" value="{{ $heading4->heading }}">
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        <input type="text" class="form-control" name="heading5" value="{{ $heading5->heading }}">
                                                    </div>
                                                    <div class="col">
                                                        <label>Product URL 4</label>
                                                        <input type="text" class="form-control" name="heading6" value="{{ $heading6->heading }}">
                                                    </div>
                                                </div>
                                                <br>
                                                ...
                                                <div class="row">
                                                    <div class="form-group">
                                                        <button id="saveHeading2" onclick="saveUrls()" class="btn btn-primary">Save</button>
                                                    </div>
                                                </div>
...
function saveUrls() {
        ...
        var heading4 = $('input[name="heading4"]').val();
        var heading5 = $('input[name="heading5"]').val();
        var heading6 = $('input[name="heading6"]').val();
