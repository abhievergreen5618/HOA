    ...
    <div class="sectionCounty">
      ...
      <div class="DataTable" style="display:none;">
        ...
        <div class="searchedData"> @foreach ($hoa as $hoaData) 
          ...
          <div class="row">
            <div class="col"> <a href="{{ asset($hoaData->image) }}" data-lightbox="example-set" ><img src="{{ asset($hoaData->image) }}" alt="UserHOA Photo"  class="thumbnail" style="width:100px;"></a> </div>
            <div class="col">
              <p>{{ $hoaData->name }}</p>
            </div>
          </div>
