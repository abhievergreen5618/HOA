                ...
                <div class="content-section">
                    <div class="section1">
                        <div class="sectionHeading">
                            <p>Florida Homeowners Associations & Condo Directory</p>
                        </div>
                    ...
                    <div class="sectionCounty">
                        <div class="countyTable">
                            <table class="CommunitytableData">
                                <thead class="tableHead">
                                    <tr>
                                        <th class="CommunitytableData">County</th>
                                        <th class="CommunitytableData">Community Name</th>
                                        <th class="CommunitytableData">HOA OR NON</th>
                                        <th class="CommunitytableData"></th>
                                    </tr>
                                </thead>
                                <tbody>
