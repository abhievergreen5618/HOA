    ...
    <div class="container">
            ...
            <div class="sectionCounty">
                ...
                <div class="sectionHeading">
                    ...
                    Please Fill Out The Short Form Below To Get An Immediate Link to Pictures And Pricing On The Next Page!</p>
                </div>
                </div>
                ...
                <div class="sectionHeading" id="hoaHeading">
                    ...
                    <hr>-->
                     ...
                     <div class="row">
                         <div class="col">
                            <a href="{{ asset($hoaData->image) }}" data-lightbox="example-set" ><img src="{{ asset($hoaData->image) }}" alt="UserHOA Photo"  class="thumbnail" style="width:100px;"></a>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                             <a href='{{ $hoaData->product_url }}' target="_blank" style="color:#0f94cb;"><?php echo $heading3->heading ?></a>
                        </div>
                      </div>
                    ...
                    @if (!empty($hoaData->product_url2))
                      <div class="row">
                        ...
                        <div class="col">
                             <a href='{{ $hoaData->product_url2 }}' target="_blank" style="color:#0f94cb;"><?php echo $heading4->heading ?></a>
                        </div>
                      </div>
                    ...
                    @if (!empty($hoaData->product_url3))
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                             <a href='{{ $hoaData->product_url3 }}' target="_blank" style="color:#0f94cb;"><?php echo $heading5->heading ?></a>
                        </div>
                      </div>
                      <br>
                      <hr>
                    ...
                    @if (!empty($hoaData->product_url4))
                      ...
                      <div class="row">
                        ...
                        <div class="col">
                             <a href='{{ $hoaData->product_url4 }}' target="_blank" style="color:#0f94cb;"><?php echo $heading6->heading ?></a>
                        </div>
                      </div>
